...
<div class="full-width-split group">
                ...
                <div class="event-summary">
                    ...
                    <div class="event-summary__content">
                        <h5 class="event-summary__title headline headline--tiny"><a
                                href="<?php echo esc_url(get_the_permalink()); ?>"><?php the_title(); ?></a></h5>
                        <p><?php echo wp_trim_words(get_the_content(), 18); ?> <a
                                href="<?php echo esc_url(get_the_permalink()); ?>" class="nu gray">Learn more</a></p>
                    </div>
                </div>
            <?php }
            wp_reset_postdata();
            ?>
            <p class="t-center no-margin"><a href="<?php echo esc_url(get_post_type_archive_link('event')); ?>"
    ...
    <div class="full-width-split__two">
        <div class="full-width-split__inner">
                    ...
                    <div class="event-summary">
                        ...
                        <div class="event-summary__content">
                            ...
                            <p><?php echo wp_trim_words(get_the_excerpt(), 18); ?> <a
                                    href="<?php echo esc_url(get_the_permalink()); ?>" class="nu gray">Read more</a></p>
                        </div>
                    </div>
                <?php }
            } else {
            ...
            <p class="t-center no-margin"><a href="<?php echo esc_url(get_post_type_archive_link('post')); ?>"
                    ...
                    <div class="hero-slider__slide" style="background-image: url(<?php echo esc_url($backgroundImage); ?>)">
                        <div class="hero-slider__interior container">
                            <div class="hero-slider__overlay">
                                ...
                                <p class="t-center no-margin"><a href="<?php echo esc_url(get_the_permalink()); ?>"
